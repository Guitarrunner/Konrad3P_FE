  ...
  return (
    <nav className={`${base}__root`}>
      ...
      <div className={`${base}__user`}>
        <div className={`${base}__user__img-container`}>
          <img
        ...
        <h1 className={`${base}__user__name`}>{currentUser.fullName}</h1>
      </div>
      <div className={`${base}__navigation`}>
        <ul className={`${base}__navigation__list`}>
          <li className={`${base}__navigation__list__element`}>
            <p className={`${base}__navigation__list__element__drop`} onMouseOver={() => displayMenu(true)}
