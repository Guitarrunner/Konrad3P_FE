  ...
  return (
    <nav className={`${base}__root`}>
      ...
      <div className={`${base}__user`}>
        ...
        <Link to="/bank/profile" className={`${base}__user__name`}>
      ...
      <div className={`${base}__navigation`}>
        <ul className={`${base}__navigation__list`}>
          <li className={`${base}__navigation__list__element`}>
            <div
              className={`${base}__navigation__list__element__drop`}
            ...
            >
              ...
              <div
                ref={menuRef}
                className={`${base}__navigation__list__element__menu`}
              >
                <Link
                  className={`${base}__navigation__list__element__menu__links`}
                  to="/bank/addMoney"
