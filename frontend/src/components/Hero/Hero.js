  ...
  return (
    <div className={`${base}__root`}>
      <div className={`${base}__img-container`}>
        <h1 className={`${base}__img-container__title`}>Universal Bank</h1>
        <h2 className={`${base}__img-container__desc`}>
          This is the new bank experience
        </h2>
        <img
          className={`${base}__img-container__img`}
          alt="Bank Logo"
          src={heroImage}
        />
      </div>
      <div className={`${base}__container`}>
        <div className={`${base}__container__data`}>
          <img
            className={`${base}__container__data__img`}
            alt="Associates"
            src={bankLogo}
          />
        ...
        <div className={`${base}__container__next`}>
          <HashLink
            to="#info"
            smooth
            className={`${base}__container__next__btn`}
          >
            &#8594;
          </HashLink>
        </div>
